...
from models.resnets import oct_resnet50, oct_resnet101, oct_resnet152
from models.resnets_small import resnet20_small, resnet44_small, resnet56_small
import wandb

os.environ["WANDB_API_KEY"] = "b0364f9b814ec8278bbaf0e3e852e41dc4f7d151"
...
def train_one_epoch(model, criterion, optimizer, data_loader,
    ...
    for image, target in meters.log_every(data_loader, logger, print_freq, header):
        ...
        loss_list.append(losses_reduced/image.size(0))
    ...
    return iter_nr, sum(loss_list)/len(data_loader)
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        iter_nr, loss = train_one_epoch(model=model, criterion=criterion,
...
if __name__ == "__main__":
    ...
    # Data
    parser.add_argument('--root', default='', required=True, help='dataset')
    ...
    # 'oct_resnet101': oct_resnet101,
    # 'oct_resnet152': oct_resnet152
    # python /sdo/cwy/octconv-master/benchmarks/train.py --root /sdk/cwy/datasets

    # Model
    parser.add_argument('--arch', default='oct_resnet152', help='model')
    parser.add_argument('--alpha', default=0.5, type=float, help='OctConv alpha parameter') # default=0.125
